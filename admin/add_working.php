        ...
        <div class="row mb-2 title1">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Working</li>
            </ol>
          </div>
          <!-- /.col -->
        </div>
          ...
          <div class="col-lg-10">
            <form method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="exampleInputFile">Add Image Works</label>
                  ...
                  <button type="submit" class="btn btn-primary">Add Working</button>
                  </div>
            </form>
<!-- ========================================================================
                                      php start 
  =========================================================================== -->
      <?php
       ...
       if($_POST)
       {
        ...
        $con->query("INSERT INTO `working`(`add_image`) VALUES ('$name')");
